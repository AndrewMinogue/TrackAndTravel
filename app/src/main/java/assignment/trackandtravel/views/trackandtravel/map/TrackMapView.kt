package assignment.trackandtravel.views.trackandtravel.map
...
class TrackMapView : AppCompatActivity() {
    ...
    fun getDirectionURL(origin:LatLng,dest:LatLng) : String{
        return "https://maps.googleapis.com/maps/api/directions/json?origin=${origin.latitude},${origin.longitude}&destination=${dest.latitude},${dest.longitude}&key=AIzaSyDWehgnsM9kZ3dL_2vszOltmqONBERKuko"
    }
